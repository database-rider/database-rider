...
Given ::
=====
DBUnit interceptor is enabled in your test beans.xml: icon:thumbs-up[role="green",title="Passed"] [small right]#(824ms)#
******
...
Given ::
=====
The following dataset icon:thumbs-up[role="green",title="Passed"] [small right]#(003ms)#
******
