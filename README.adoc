...
A getting started guide can be found here http://database-rider.github.io/getting-started/getting-started.html.

For main features overview see project living documentation (of each project version):

http://database-rider.github.io/database-rider/index.html.
...
TIP: Full example above (and other related tests) can be https://github.com/database-rider/database-rider/blob/master/rider-core/src/test/java/com/github/database/rider/exporter/ExportDataSetIt.java#L35[found here^].
...
You can export datasets using https://forge.jboss.org/[JBoss forge addon^], see https://github.com/dbunit-addon/[DBUnit Addon^].
