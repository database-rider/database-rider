...
image:https://maven-badges.herokuapp.com/maven-central/com.github.database-rider/rider-core/badge.svg["Maven Central",link="http://search.maven.org/#search|ga|1|database-rider"]
...
A getting started guide can be found here http://database-rider.github.io/database-rider-sample/database-rider.html.

For main features overview see project living documentation: http://database-rider.github.io/database-rider/documentation.html.
...
* https://github.com/database-rider/database-rider/tree/master/examples/jpa-productivity-boosters[JPA productivity boosters^]
* https://github.com/database-rider/database-rider/tree/master/examples/dbunit-tomee-appcomposer-sample[DBUnit Application Composer^]
* https://github.com/database-rider/database-rider/tree/master/examples/jOOQ-DBUnit-flyway-example/[jOOQ Flyway DBUnit^]
* https://github.com/database-rider/database-rider/tree/master/examples/spring-boot-dbunit-sample/[SpringBoot Data DBUnit^]

And also each module contain a lot of tests that you can use as example.

== Rider Core

This module is the basis for subsequent modules. It contains a JUnit rule (shown above), the api for dataset and DBunit configuration and *DataSetExecutor* which is responsible for dataset creation.
...
<dependency>
      ...
      <artifactId>database-rider</artifactId>
...
NOTE: A hibernate entity manager config sample can be https://github.com/database-rider/database-rider/blob/master/examples/src/test/resources/META-INF/persistence.xml[found here^].


TIP: EntityManager provider utility also can be used in other contexts like a CDI producer, https://github.com/database-rider/database-rider/blob/master/rider-cdi/src/test/java/com/github/database/rider/EntityManagerProducer.java#L21[see here].
...
TIP: Complete source code of example above can be https://github.com/database-rider/database-rider/blob/master/rider-core/src/test/java/com/github/database/rider/LeakHunterIt.java[found here^].
...
TIP: Full example above (and other related tests) can be https://github.com/database-rider/database-rider/blob/master/rider-core/src/test/java/com/github/database/rider/ExportDataSetIt.java#L35[found here^].
