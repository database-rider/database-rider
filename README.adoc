...
properties:
  ...
  escapePattern:
  schema:
  datatypeFactory: !!com.github.database.rider.core.configuration.DBUnitConfigTest$MockDataTypeFactory {} <5>
  tableType: ["TABLE"]
connectionConfig:
  driver: ""
  url: ""
...
<5> Make it possible to define a datatype factory, https://github.com/database-rider/database-rider/issues/30[see issue #30^] for details.
